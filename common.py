...
# 10 mappe distinte, tutte della STESSA dimensione standard 39x19
# (la dimensione della mappa piu' grande tra quelle originali, 'Corallo
# Tramonto'): stessa griglia totale (741 celle) e densita' muri/spazi
# pressoche' identica tra loro, ma disposte in modo diverso. Generate
# proceduralmente con un labirinto perfetto (recursive backtracker) poi
# "braided" per aggiungere anelli percorribili e specchiate in
# orizzontale per la classica simmetria da arcade. Ognuna e' stata
# verificata via flood-fill: tutte le celle libere sono raggiungibili
# tra loro (nessuna zona isolata) => sempre giocabile. I 4 angoli
# (1,1) / (w-2,1) / (1,h-2) / (w-2,h-2) sono garantiti aperti dalla
# costruzione del labirinto: servono come possibile sede dei portali
# diagonali (vedi compute_portals in main.py).
MAZES = [
    {
        "name": 'Neon Blu',
        "maze": [
    ...
    },
    {
        ...
        "spawn_points": [[2, 1], [36, 1], [1, 16], [35, 16], [19, 9]],
